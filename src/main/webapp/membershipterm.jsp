...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="resources/css/membershipterm.css">
  </head>
  <body>
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      ...
	      <div class="navbar-right" id="ftco-nav" style="display:flex; margin-left:100px; margin-top:10px;">
	      	<a href="#" class="navbar-link" style="margin-right:10px;"><p style="color:black">로그인</p></a>
	      	<a href="#" class="navbar-link"><p style="color:black">회원가입</p></a>
	      </div>
	    </div>
	  </nav>
    <!-- END nav -->
    ...
    <section class="ftco-section ftco-no-pb">
      <div class="contain" id="member_form">
        <div class="term_contain">
          ...
          <div class="sub_text">
            <div>개인정보 수집 및 이용 동의 <span>(필수)</span>
            ...
            <textarea readonly>개인정보처리방침
              ...
              1) 공고일자 : 2022년 03월 28일
              2) 시행일자 : 2022년 03월 28일</textarea>
          </div>
          <a href="memberinsertform.do"><button class="join_btn">회원가입 시작</button></a>
        </div>
      </div>
    </section>
  ...
  <script src="resources/js/membershipterm.js"></script>
