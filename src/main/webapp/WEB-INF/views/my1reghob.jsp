...
<body>
    ...
    <div id="contain">
      <div>
       ...
       <ul class="list_contain">
        <br/>
       		<table id="reglist" border="1">
             	    <tr align = "center" bgcolor ="#d4ca68">
					<th>No</th>
					<th>취미명</th>
					<th>등록날짜</th>
					<th>수정하기</th>
					...
					<c:forEach items="${selectreghob}" var="meeting">
					  <tr align ="center"><!-- 첫번째 줄 시작 -->
					   <td>${meeting.ROWNUM}</td>
					   <td>${meeting.TITLE}</td>
					   <td>${meeting.REG_DATE}</td>
					   <td><a href="modifyreghob.do?meetingId=${meeting.MEETING_ID }"><input id="modifyBtn" type="button" class="button2" value="수정"></a></td>
					   <td><a href="deletereghob.do?meetingId=${meeting.MEETING_ID }"><input id="deleteBtn" type="button" class="button2" value="삭제"></a></td>
					</tr><!-- 첫번째 줄 끝 -->  
					</c:forEach>
			</table>
 ...
 <script src="resources/js/jquery.min.js"></script>
  ...
  <script src="resources/js/listtable.js"></script>
