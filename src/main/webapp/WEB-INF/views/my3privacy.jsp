...
<html>
 <head>
    ...
    <link rel="stylesheet" href="resources/css/my3privacy.css">
...
<body>
     ...
     <div id="contain">   	 
    	...
    	<div>
	    	<ul class="list_contain">
		    	<table class="tb_privacy">
		    		  <tr>
			            <td colspan="2"><h4>로그인 정보</h4></td>
			          </tr>
					  <tr>
					    <th>이름</th>
					    <td>${selectmyprofile.name}</td>
					  </tr>
					  <tr>
					    <th>이메일</thd>
					    <td>${selectmyprofile.email}</td>
					  </tr>
					  <tr>
					    <th>전화번호</th>
					    <td>${selectmyprofile.tel}</td>
					  </tr>
				</table>	
				<a href="modifyprivacy.do?memberId=${sessionScope.memberId}"><input id="modifyBtn" type="button" class="button2" value="수정"></a>
			</ul>
		</div>
	<hr/>
 ...
 <script src="resources/js/jquery.min.js"></script>
  ...
  <script src="resources/js/my3privacy.js"></script>
