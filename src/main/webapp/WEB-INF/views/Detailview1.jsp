...
<link rel="stylesheet" href="resources/css/detailview1.css">
  ...
  <body>
		...
		<div class="container">
			<a class="navbar-brand" href="index.html"><img alt="취미에 바나나"
				src="resources/images/mainlogo.png" style="width:200px;height:180px;"></a>
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-12 heading-section text-center ftco-animate mb-5">
					...
					<div class="bxcenter">
						<div class="bxslider">
							<a href="resources/meetingImg/${ meeting.FIRST_REAL_IMG }" data-lightbox="image-1" data-title="상세보기"> 
								<img style="" src="resources/meetingImg/${ meeting.FIRST_REAL_IMG }" />
							</a>
							<a href="resources/meetingImg/${ meeting.SECOND_REAL_IMG }" data-lightbox="image-1" data-title="상세보기"> 
								<img style="" src="resources/meetingImg/${ meeting.SECOND_REAL_IMG }" />
							</a>
							<a href="resources/meetingImg/${ meeting.THIRD_REAL_IMG }" data-lightbox="image-1" data-title="상세보기"> 
								<img style="" src="resources/meetingImg/${ meeting.THIRD_REAL_IMG }" />
							</a>
						</div>
					</div>
					<div class="center">
						<div>
							<form class="frm">
								<div class="titlebox">${ meeting.TITLE }</div><br/>
									<div class="bottom"></div><br/>
										<div class="daybox">
											<c:set var="date" value="${ meeting.MEETING_DATE }" />
											<c:set var="time" value="${ meeting.MEETING_TIME }" />
											<span id="day">진행일자 </span><span id="day1"> ${ fn:substring(date,0,10) } ${ fn:substring(time,11,16) }</span>
											<span><button type="button" class="scrap"><i class="fa-regular fa-star"></i>즐겨찾기</button></span>
											<input id="memberId" name="member_id" type="hidden" value="${ sessionScope.memberId }"/>
			                                 <input id="hostId" name="host_id" type="hidden" value="${ meeting.HOST_ID }"/>
			                                 <input id="meetingId" name="meeting_id" type="hidden" value="${ meeting.MEETING_ID }"/>
											<span id="webicon3"><i class="fa-regular fa-heart"></i></span>
										</div>
										<div class="areabox">
											<span id="area">진행장소 </span><span id="area1">${ meeting.LOCATION } ${ meeting.DETAIL_LOCATION }</span>
										</div>
										<div class="peoplebox">
											<span id="people">참여인원 </span><span id="people1">${ meeting.MEMBER_COUNT }</span><span> 명</span>
										</div>
									<div class="hostbox"><br/>
										<div class="profilefix">
											<img src="resources/images/profile.jpg" />
										</div>
										<div>
											<div class="text1">
												<span class="hostintro">호스트</span><span>호스트 상세보기</span>
												<span><a href="main.html"><i class="fa-regular fa-thumbs-up" id="webicon1"></i></a><a href="index.html"><i class="fa-solid fa-land-mine-on" id="webicon2"></i></a></span>
											</div>
											<div class="text2">${ meeting.NAME }</div>
											<div class="text3">${ meeting.INTRODUCE }</div>
										</div>
									</div><br/>
										<div class="content">내용 ${ meeting.CONTENT }</div>	
								<button type="button" id="button" class="btn">신청하기</button>
							</form>
						</div>
					</div>
				</div>
