		...
		<div class="container1">
			<div class="container2">
				...
				<form action="updatequestion.do" method="post">
					...
					<input type='hidden' name='writeDate' value='${ question.writeDate }'> 
					<div>
						<div class="title">
							<span>제목</span><span><input type="text"
								class="questiontitle" value="${ question.title }" name="title" /></span>
						</div>
						<div class="content1">
							<span>내용</span> <span><textarea rows="10" cols="500"
									class="questioncontent" 
									name="content">${ question.content }</textarea></span>
						</div>
						<div class="password">
							<span>비밀번호</span><span><input type="text"
								class="questionpass" value="${ question.password }"
								name="password" /></span>
						</div>
						<div class="button">
							<span><button type="submit">완료</button></span> 
							<span><a href="qnalist.do"><button type="button">뒤로가기</button></a></span>
						</div>
					</div>
				</form>
			</div>
