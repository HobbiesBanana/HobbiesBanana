	       ...
	       <ul class="list_contain">
	        <br/>
	       		<table id="reglist" border="1">
						...
						<c:forEach items="${selectwishlist}" var="wishlist">
						  <tr align ="center">
						   <td>${wishlist.ROWNUM}</td>
						   <td>${wishlist.TITLE}</td>
						   <td>${wishlist.CATEGORY_NAME}</td>
						   <td><a href="deletewishlist.do?wishId=${wishlist.WISH_ID }"><input id="deleteBtn" type="button" class="button2" value="삭제"></a></td>
						  </tr>
						</c:forEach>
