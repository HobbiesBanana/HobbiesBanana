...
<body>
     ...
     <div id="contain">   	 
	   <div>
    		<aside>
				...
				<form id="deleteaccount" action="deleteaccount.do" method="post">
					 <fieldset>
						<div class="password">
							<label class="control-label" for="password"><h4>개인정보 확인을 위해 비밀번호를 입력하세요.</h4></label></br>
						...
						<div>
							<c:if test="${ message == 'error' }">
			            		<div id="errortext">비밀번호를 잘못 입력했습니다.<br/></div>
			           	 	</c:if>
						</div>
					</fieldset>
				</form>
 ...
 <script src="resources/js/jquery.min.js"></script>
  ...
  <script src="resources/js/delectaccount.js"></script>
