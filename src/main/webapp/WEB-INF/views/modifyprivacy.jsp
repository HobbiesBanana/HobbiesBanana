...
<body>
    ...
    <section class="ftco-section testimony-section bg-light">
     ...
     <div id="contain">   	 
    	...
    	<div>
    	 <form action="updateprivacy.do" method="post" enctype="multipart/form-data">
	    	<h4>로그인 정보</h4><hr/>
	    	<ul class="list_contain">
		    	<table id="reglist2">
					  <tr>
					    <td>이름</td>
					    <td><input type="text" id="profilename" name="name" value="${selectmyprofile.name}"></td>
					    
					  </tr>
					  <tr>
					    <td>이메일</td>
					    <td><input type="text" id="profilename" name="email" value="${selectmyprofile.email}"></td>
					  </tr>
					  <tr>
					    <td>전화번호</td>
					    <td><input type="text" id="profilename" name="tel" value="${selectmyprofile.tel}"></td>
					  </tr>
				</table>	
				<input type="hidden" name="memberId" value="${ sessionScope.memberId }" />
				<input id="updateBtn" type="submit" class="button2" value="완료" />
			</ul>
			</form>
		</div>
	<hr/>
