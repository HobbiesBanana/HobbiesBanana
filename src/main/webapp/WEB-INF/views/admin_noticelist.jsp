	...
	<div class="admin-total">
		...
		<div class="adminmain">
			<div class="adminsearch">
			  	<a href ="noticeinsertset.do"><input type="button" value="공지사항등록" style="float:left;border:none; width: 120px; height: 40px;"/></a>
				<br/><br/>
			</div>
			...
			<div>
        		...
        		<thead>
        		<tr>
        			<td class = "member_td1"><b>공지사항 번호</b></td>
        			<td class = "member_td1"><b>공지사항 제목</b></td>
        			<td class = "member_td1"><b>공시사항 등록일</b></td>
        	...
        	<tbody>	
        		<c:forEach items="${noticelist}" var="notice">
        			<tr>
        				...
        				<td><a href="noticeSet.do?noticeId=${notice.noticeId}"><input type ="button" value="상세보기" style="border:none;"></a></td>
        			</tr>
        		</c:forEach>
        	</tbody>
        	</table>
