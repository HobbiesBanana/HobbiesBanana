		...
		<div class="adminmain">
			...
			<div>
        		...
        		<tr>
        			...
        			<td class="memberset_td1"><input type="text" size="70" name="title"/></td>
        		</tr>
        		<tr>
        			<td class="memberset_td1"><b>시작일</b></td>
        			<td class="memberset_td1"><input type="date" size="70" name="eventDateStart"/></td> 
        		</tr>
        		<tr>
        			<td class="memberset_td1"><b>종료일</b></td>
        			<td class="memberset_td1"><input type="date" size="70" name="eventDateEnd"/></td> 
        		</tr>
        		<tr>
        		<td class="memberset_td1"><b>이벤트 이미지</b></td>
        		<td class="memberset_td1">              
        		<img id="preview-image" src="https://dummyimage.com/500x500/ffffff/000000.png&text=Insert Image">
        		<input id="input-image" type="file" name="file" required/>
        		</td>
        		</tr>
        		<tr>
        		<td class="memberset_td1"><b>내용</b></td>
        		<td class="memberset_td1"><input type="text" size="70" name="content"></td>
        		</tr>
        		<tr>
        		<td class="memberset_td1"><b>링크</b></td>
        		<td class="memberset_td1"><input type="url" size="70" name="link"></td>
        		</tr>
        	 </table>
				</div>
