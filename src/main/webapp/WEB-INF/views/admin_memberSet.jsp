	...
	<div class="admin-total">
		...
		<div class="adminmain">
			<div class="adminsearch">
			  	 <b  style ="float:left;">회원 찾기</b><br/>
       	 <select name="searchCondition" style="width:100px;height:35px;">
       	 		<option value="email" >이메일</option>
       	 		<option value="name" >이름</option>
       	 	</select>
       	 <input type="text" name="searchKeyword" size="85" placeholder="검색하세요" onfocus="this.placeholder=''" onblur="this.placeholder='검색하세요'">&nbsp;
       	 <input type="submit" value="검색" style="width: 70px; height: 35px; border:2px;">
			<br/><br/>
			</div>
        	...
        	<thead>
        		<tr>
        		<td class = "member_td1"><b>회원번호</b></td>
        		<td class = "member_td1"><b>이메일</b></td>
        		<td class = "member_td1"><b>이름</b></td>
        		<td class = "member_td1"><b>최근접속날짜</b></td>
        		<td class = "member_td1"><b>상세보기</b></td> 
        		</tr>
        	</thead>
        	<tbody>	
        		<c:forEach items="${memberSet}" var="member">
        			<tr>
        				<td class = "member_td2">${member.memberId}</td>
        				<td class = "member_td2">${member.email}</td>
        				<td class = "member_td2">${member.name}</td>
        				<td class = "member_td2">${member.lastConDate}</td>
        				<td class = "member_td2"><a href="memberSet2.do?memberId=${member.memberId}"><input type ="button" value="상세보기" style=" border:2px;"></a></td>
        			</tr>
        		</c:forEach>
        	</tbody>
        	</table>
