  ...
  <body>
    ...
    <section class="hero-wrap hero-wrap-2 ftco-degree-bg js-fullheight" data-stellar-background-ratio="0.5">
        <div  style="background-image:url('resources/images/관리자배경3.jpg'); background-size: cover;" class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
          ...
          <h1>관리자 페이지</h1><br/>
           <h5>회원 관리 > 이벤트 상세 조회</h5>
           <br/><br/><br/>
          </div>
        </div>
    </section>
 
   <form action="eventlist2.do" method="post">
   <section id="asd" class="ftco-section contact-section">
	...
	<div class="admin-total">
		...
		<div class="adminmain">
			<div>
				<b style="float: left;"> ◈ 이벤트 번호 &nbsp &nbsp ${eventSet.eventId}</b>
				<br/><br/>
			</div>
			<div>
        		...
        		<td class="memberset_td1">${eventSet.title}</td> 
        		</tr>
        		<tr>
        		<td class="memberset_td1"><b>이벤트사진</b></td>
        		<td class="memberset_td1"><img src="resources/eventimages/${eventSet.eventRealImg}" id="member_img"/></td>
        		</tr>
        		<tr>
        		<td class="memberset_td1"><b>내용</b></td>
        		<td class="memberset_td1"><div id="event-text">${eventSet.content}</div></td>
        		</tr>
        		<tr>
        		<td class="memberset_td1"><b>인원수</b></td>
        		<td class="memberset_td1">${eventSet.peopleCount}</td>
        		</tr>
        		<tr>
        		<td class="memberset_td1"><b>기간</b></td>
        		<td class="memberset_td1">${eventSet.eventDateStart.substring(0,10)} ~ ${eventSet.eventDateEnd.substring(0,10)}</td>
        		</tr>
        		<tr>
        		<td class="memberset_td1"><b>링크</b></td>
        		<td class="memberset_td1"><div id="event-text">${eventSet.link}</div></td>
        	 	</tr>
        	 </table>
				</div>
			...
			<br/>
			 <center>
        	<a href="eventlist.do"><input type ="button" value = "목록" style='border:none; width: 70px; height: 35px;margin: 2px;'></a>
        	<a href="eventDelete.do?eventId=${eventSet.eventId}"><input type="button" value="삭제" style='border:none; width: 70px; height: 35px;margin: 2px;'/></a>
      		</center>     		
			</div>
		</div>
	</div>
