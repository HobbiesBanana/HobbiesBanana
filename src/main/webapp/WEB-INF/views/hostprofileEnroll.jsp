...
<body>
	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      ...
	      <div class="navbar-right" id="ftco-nav" style="margin-left:100px; margin-top:10px;">
	      	<a href="#" class="navbar-link"><p style="color:black">로그인/회원가입</p></a>
	      </div>
	    </div>
	  </nav>
     ...
     <div id="contain">   	 
		<div>
    		<aside>
			      ...
			      <li><a href="my1reghob.do?hostId=${sessionScope.memberId }">등록 취미 조회</a></li>
			      ...
			      <li><a href="my2hostagree.do">호스트 인증 신청</a></li>
			      <li><a href="my2hostprofile.do?hostId=${sessionScope.memberId }">프로필 관리</a></li>
	       ...
	       <div>
		       <form action="hostprofileinsert.do" method="post" enctype="multipart/form-data">
		       	<img id="preview-image" class="profilephoto" src="resources/images/defaultimg.jpg" />
		       	<input id="input-image" type="file" name="file" />
		       	<input type="hidden" name="memberId" value="${ sessionScope.memberId }">
				<br/><br/>
				<textarea id="profiletext" name="introduce"></textarea><br/>
		    	<input type="submit" class="completeprofileBtn" value="완료하기">
		       </form>
	      </div>
       </div> 
    </section>
