   ...
   <section id="asd" class="ftco-section contact-section">
	...
	<div class="admin-total">
		...
		<div class="adminmain">
        	...
        	<thead>
        		<tr>
        			<td class = "member_td1"><b>NO</b></td>
        			<td class = "member_td1"><b>title</b></td>
        			<td class = "member_td1"><b>작성날짜</b></td>
        			 <td class = "member_td1"><b>Answer</b></td>
        			 <td class = "member_td1"><b>답글쓰기</b></td> 
        		</tr>
        	</thead>
        	<tbody>
        		<c:forEach items="${qnaList}" var="qna">
        			<tr>
        				...
        				<td>${qna.writeDate}</td>
        				<td>${qna.answer}</td>
        				<td><a href="qnaSet.do?questionId=${qna.questionId}"><input type ="button" value="상세보기" style="border:none;"></a></td>
        			</tr>
        		</c:forEach>
        	</tbody>
        	</table>
