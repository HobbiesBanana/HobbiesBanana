  ...
  <body>
	...
	<div class="admin-total">
		...
		<table class="admin_table">
        		<tr>
        			<td class = "member_td1"><b>리스트 번호</b></td>
        			<td class = "member_td1"><b>회원번호</b></td>
        			<td class = "member_td1"><b>신고 사유</b></td>
        			<td class = "member_td1"><b>등록날짜</b></td>
        			<td class = "member_td1"><b>신고인</b></td>
        			<td class = "member_td1"><b>처리결과</b></td>
        			<td class = "member_td1"><b>신고 상세 보기</b></td> 
        		</tr>
        
        	<tbody>
        	    <c:forEach items="${blacklistList}" var="blacklist">
        			<tr>
        				<td>${blacklist.LIST_ID}</td>
        				<td>${blacklist.MEMBER_ID}</td>
        				<td>${blacklist.CONTENT}</td>
        				<td>${blacklist.REG_DATE}</td>
        				<td>${blacklist.WRITER}</td>
        				<td>${blacklist.APPROVAL}</td>
        				<td><a href="blacklist2.do?listId=${blacklist.LIST_ID}"><input type="button" value="상세보기" style="border:none;"/></a></td>
        			</tr>
        		</c:forEach>
			</tbody>
        	</table>
