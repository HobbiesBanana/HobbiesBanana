		...
		<div class="adminmain">
			...
			<div>
				<table class="admin_table1">	
        			<tr>
        			<td class="memberset_td1" colspan="2"><b>프로필사진</b></td><td colspan="2" class="memberset_td1"><img src="resources/memberimages/${memberSet.realImg}" id="member_img"/></td>
        			</tr>
        			<tr> 
        			<td class="memberset_td1"><b>회원번호</b></td><td class="member_td">${memberSet.memberId}</td>
        			<td class="memberset_td1"><b>이름</b></td><td class="member_td">${memberSet.name}</td>
        			</tr>
        			<tr>
        			<td class="memberset_td1"><b>나이</b></td><td class="memberset_td1">${memberSet.age}</td>
        			 <td class="memberset_td1"><b>성별</b></td><td class="memberset_td1">${memberSet.gender}</td>
					</tr>      		
        			<tr> 
        			<td class="memberset_td1"><b>이메일</b></td><td class="memberset_td1">${memberSet.email}</td>
        			<td class="memberset_td1"><b>비밀번호</b></td><td class="memberset_td1">${memberSet.password}</td> 
        			</tr>
        			<tr>	 
        			 <td class="memberset_td1"><b>전화번호</b></td><td class="memberset_td1">${memberSet.tel}</td>
        			 <td class="memberset_td1"><b>가입날짜</b></td><td class="memberset_td1">${memberSet.joinDate}</td>
        			</tr>
        			<tr>	 
        			  <td class="memberset_td1"><b>최근접속일</b></td><td class="memberset_td1">${memberSet.lastConDate}</td>
        			  <td colspan="2" class="memberset_td1"></td>
					</tr>        	
        			</table>
				</div>
			...
			<div>
				<center>
        		<a href="memberSet.do"><input type ="button" value = "목록" style='border:none; width: 70px; height: 35px; margin:2px;'></a>
        		<a href="deleteMemberSet.do?memberId=${memberSet.memberId}"><input type ="button" value = "삭제" style='border:none; width: 70px; height: 35px;margin: 5px;'></a>
				</center>      		
			</div>
		</div>
	</div>
