  ...
  <body>
    ...
    <section class="hero-wrap hero-wrap-2 ftco-degree-bg js-fullheight" data-stellar-background-ratio="0.5">
        <div  style="background-image:url('resources/images/관리자배경3.jpg'); background-size: cover;" class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
          ...
          <h1>관리자 페이지</h1><br/>
           <h5>이벤트 관리 > 이벤트 목록 조회</h5>
           <br/><br/><br/>
          </div>
        </div>
    </section>
 
	<form action="eventlist.do" method="post">
	...
	<div class="admin-total">
		...
		<div class="adminmain">
			<div class="adminsearch">
			  	<a href ="eventInsertlist.do"><input type="button" value="이벤트등록" style="float:left;border:none; width: 100px; height: 40px;"/></a>
				<br/><br/>
			</div>
			...
			<div>
        		...
        		<thead>
        		<tr>
        			<td class = "member_td1"><b>이벤트 제목</b></td>
        			<td class = "member_td1"><b>이벤트 날짜</b></td>
        			<td class = "member_td1"><b>모집인원</b></td>
        	...
        	<tbody>	
        		<c:forEach items="${eventList}" var="event">
        			<tr>
        				<td>${event.title}</td>
        				<td>${event.eventDateStart.substring(0,10)} ~ ${event.eventDateEnd.substring(0,10)}</td>
        				<td>${event.peopleCount}</td>
        				<td><a href="eventlist2.do?eventId=${event.eventId}"><input type ="button" value="상세보기" style="border:none;"></a></td>
        			</tr>
        		</c:forEach>
        	</tbody>
        	</table>
