...
<link rel="stylesheet" href="resources/css/questioninsert.css">
		...
		<div class="container1">
			<div class="container2">
				...
				<form action="insertquestion.do" method="post">
					<div>
						<div class="title">
							<span>제목</span><span><input type="text"
								class="questiontitle" placeholder="제목을 입력해주세요"
								onfocus="this.placeholder = ''"
								onblur="this.placeholder = '제목을 입력해주세요'" name="title" /></span>
						</div>
						<div class="content1">
							<span>내용</span> <span><textarea rows="10" cols="500"
									class="questioncontent" placeholder="내용을 입력해주세요"
									onfocus="this.placeholder = ''"
									onblur="this.placeholder = '내용을 입력해주세요'" name="content"></textarea></span>
						</div>
						<div class="password">
							<span>비밀번호</span><span><input type="text"
								class="questionpass" placeholder="비밀번호"
								onfocus="this.placeholder = ''"
								onblur="this.placeholder = '비밀번호'" name="password" /></span>
						</div>
						<input type="hidden" name="memberId"
							value="${ sessionScope.memberId }">
						<div class="button">
							<span><button type="submit">완료</button></span> <span><a href="qnalist.do?qpage=1&npage=1"><button
									type="button">뒤로가기</button></a></span>
						</div>
					</div>
				</form>
			</div>
