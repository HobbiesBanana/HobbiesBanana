  ...
  <body>
    ...
    <section class="hero-wrap hero-wrap-2 ftco-degree-bg js-fullheight" data-stellar-background-ratio="0.5">
        <div  style="background-image:url('resources/images/관리자배경3.jpg'); background-size: cover;" class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
          ...
          <h1>관리자 페이지</h1><br/>
           <h5>게시물 관리 >게시물 목록 조회</h5>
           <br/><br/><br/>
          </div>
        </div>
    </section>
 
	<form action="meetinglist.do" method="post">
	...
	<div class="admin-total">
		...
		<div class="adminmain">
			<div class="adminsearch">
			  	 <b style ="float:left;">게시물 찾기</b><br/>
       		<select name="meeting_search" style="width:100px;height:35px;">
       	 		<option value="title">취미명</option>
       	 		<option value="name">호스트명</option>
       	 	</select>
       	 	<input type="text" name="meeting_searchKeyword" size="87" placeholder="검색하세요" onfocus="this.placeholder=''" onblur="this.placeholder='검색하세요'">&nbsp;
        	<input type="submit" value="검색" style=" border:none; width: 70px; height: 35px;"/>
        	<br/><br/>
			</div>
			...
			<table class="admin_table">
        		<thead>
        		<tr>
        			<td class = "member_td1"><b>방번호</b></td> 
        			<td class = "member_td1"><b>취미명</b></td> 
        			<td class = "member_td1"><b>내용</b></td>
        			<td class = "member_td1"><b>호스트명</b></td>
        			...
        			<tr>
        				...
        				<td>${meeting.NAME}</td>
        				<td><a href="meetinglist2.do?meetingId=${meeting.MEETING_ID}"><input type="button" value="상세보기" style="border:none;"/></a></td>
        			</tr>
        		</c:forEach>
        		</tbody>
        	</table>
