	...
	<div class="admin-total">
		...
		<div class="adminmain">
			...
			<table  class="admin_table1">
       	 	<tr>
       	 	<td class="memberset_td1"><b>NO</b></td>
       	 	<td class="memberset_td1">${qnaSet.QUESTION_ID}</td>
       	 	</tr>
       	 	<tr>
       	 	<td class="memberset_td1"><b>작성날짜</b></td>
       	 	<td class="memberset_td1">${qnaSet.WRITE_DATE}</td>
        	</tr>
        	<tr>
        	<td class="memberset_td1"><b>회원 이름</b></td>
        	<td class="memberset_td1">${qnaSet.NAME}</td>
        	</tr>
        	<tr>
        	<td class="memberset_td1"><b>제목</b></td>
        	<td class="memberset_td1">${qnaSet.TITLE}</td>
        	</tr>
        	<tr><td class="memberset_td1"><b>내용</b></td>
        	<td class="memberset_td1">${qnaSet.CONTENT}</td>
        	</tr>
        	<tr>
        	<td class="memberset_td1"><b>답글작성<b></td>
        	<td class="memberset_td1"><input type ="text" name="answer" placeholder="내용을 입력하세요" onfocus="this.placeholder=''" onblur="this.placeholder='내용을 입력하세요'" style="width:500px;height:350px;"></td>
			</tr>
			<input type="hidden" value="${qnaSet.QUESTION_ID}" name="questionId"/>
   			 </table>
				</div>
