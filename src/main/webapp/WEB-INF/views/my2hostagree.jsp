...
<body>
    ...
    <section class="ftco-section testimony-section bg-light">
     ...
     <div id="contain">   	 
    	...
    	<div>
    		<ul class="list_contain"><br/>
    			<h3>게스트에게 만족도 높은 취미 활동을 제공하기 위해<br/> 호스트는 다음 요건을 충족해야 합니다.</h3><hr/>
			         <p>신속한 응답: 24시간 이내에 문의 및 활동 요청에 응답하여 높은 응답률을 유지하세요.<br/>
					    활동 요청 수락: 게스트가 환영받는 느낌이 들도록 호스팅이 가능할 때마다 예약 요청을 수락해주세요.<br/>
						높은 전체 평점 유지: 게스트는 만족도 높은 취미 활동을 기대합니다.<br/><br/>
							
						필수 편의시설<br/>
						모든 숙소에 필수 편의시설을 갖추시기를 강력히 권장합니다. 편안한 숙박을 위해 게스트가 중시하는 물품에는 <br/>
						화장지, 수건, 침구, 베개, 손 세정제, 보디클렌저 등이 포함됩니다.</p>
						
						<td><input type="checkbox" id="check1">호스트 개인정보 동의</td>
						<a href="hostprofileEnroll.do"><input type="button" class="hostagreeBtn" value="신청하기"></a>
    	  	</ul>
    	</div>
 ...
 <script src="resources/js/jquery.min.js"></script>
  ...
  <script src="resources/js/hostagree.js"></script>
